...
module_water_L1233.Elec_water <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    return(c(FILE = "common/iso_GCAM_regID",
             ...
             FILE = "energy/L101.en_bal_EJ_ctry_Si_Fi_Yh_full",
    ...
    L101.en_bal_EJ_ctry_Si_Fi_Yh_full <- get_data(all_data, "energy/L101.en_bal_EJ_ctry_Si_Fi_Yh_full")
    ...
    L1233.out_EJ_R_elec_F_tech_Yh_cool %>%
      ...
      add_precursors("common/iso_GCAM_regID",
                     ...
                     "energy/L101.en_bal_EJ_ctry_Si_Fi_Yh_full",
                     "L1231.in_EJ_R_elec_F_tech_Yh",
                     "L1231.out_EJ_R_elec_F_tech_Yh",
